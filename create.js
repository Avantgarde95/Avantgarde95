...
function mapBadges(input) {
  ...
  const badgeMap = {
    ...
    eslint: ["ESLint", "ESLint", "100000", null, "eslint"],
    stylelint: ["StyleLint", "StyleLint", "100000", null, "stylelint"],
    webpack: ["Webpack", "Webpack", "100000", null, "webpack"],
    jest: ["Jest", "Jest", "100000", null, "jest"],
    storybook: ["Storybook", "Storybook", "100000", null, "storybook"],
    ionic: ["Ionic", "Ionic", "100000", null, "ionic"],
    socketio: ["Socket.io", "Socket.io", "100000", null, "socketdotio"],
    opengl: ["OpenGL", "OpenGL", "100000", null, "opengl"],
    solidity: ["Solidity", "Solidity", "100000", null, "solidity"],
