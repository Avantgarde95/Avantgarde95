...
function mapBadges(input) {
  return input
    ...
    .replace(/<aws\/>/g, "![AWS](https://img.shields.io/badge/AWS-FF9900?style=for-the-badge&logo=amazonaws&logoColor=white)")
    ...
    .replace(/<ionic\/>/g, "![Ionic](https://img.shields.io/badge/Ionic-100000?style=for-the-badge&logo=ionic&logoColor=white)")
    .replace(/<socketio\/>/g, "![Socket.io](https://img.shields.io/badge/Socket.io-100000?style=for-the-badge&logo=socketdotio&logoColor=white)")
    .replace(/<opengl\/>/g, "![OpenGL](https://img.shields.io/badge/OpenGL-100000?style=for-the-badge&logo=opengl&logoColor=white)")
    .replace(/<solidity\/>/g, "![Solidity](https://img.shields.io/badge/Solidity-100000?style=for-the-badge&logo=solidity&logoColor=white)")
    .replace(/<express\/>/g, "![Express](https://img.shields.io/badge/Express-100000?style=for-the-badge&logo=express&logoColor=white)")
    ;
}
